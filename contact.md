...
<div class="h-100 pb-5 jumbotron jumbotron-fluid bg-red">
    ...
    <div class="text-center text-center">
        <h2 class="text-white">If you have any questions contact us</h2>
    </div>
    <div class="d-flex justify-content-center align-content-end w-100 h-100">
    <div>
        <a class="trial-btn write-us-btn btn btn-lg" title="" href="mailto:ask@restheart.org?subject=I Want More Informations About RESTHeart" target="blank"> <i style="font-size:18px" class="icon-mail"></i> Write us! </a>
        </div>
    </div>
