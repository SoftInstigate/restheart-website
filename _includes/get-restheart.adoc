...
Sign up at https://cloud.restheart.com/?utm_source=restheart.org&utm_medium=docs&utm_content=get-restheart[*cloud.restheart.com*] and create a free API service in minutes.

Set up your root user following the link:https://cloud.restheart.com/docs/root-user-setup[Root User Setup guide].
...
The fastest way to get started is with https://cloud.restheart.com/?utm_source=restheart.org&utm_medium=docs&utm_content=get-restheart[*RESTHeart Cloud*]. Create a free service in minutes:

. Sign up at https://cloud.restheart.com/?utm_source=restheart.org&utm_medium=docs&utm_content=get-restheart[cloud.restheart.com]
