...
<section id="top" class="text-center pt-4 pb-5">
    <section class="my-0">
        ...
        <p class="mt-2 ml-3 ml-md-5 top-4 text-break" style="color:orange">Declarative authentication and authorization. Instant REST, GraphQL and WebSocket API on MongoDB. Fully customizable with Java, Kotlin, JavaScript or TypeScript.</p>
    </section>
    <div class="row mt-4">
