...
NOTE: `restheart-mqtt` ships separately from RESTHeart and is not yet part of a release, so the keys below may still change between snapshots — pin the build you install. See link:/docs/mqtt/[MQTT Overview].
