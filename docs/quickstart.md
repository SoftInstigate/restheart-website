...
Alternatively, use a command line HTTP client like [curl](https://curl.haxx.se), [httpie](https://httpie.org) or an API client like [Postman](https://www.postman.com).
...
Configuration files are within the `etc/` folder.
