...
Sophia is delivered as a managed *RESTHeart Cloud — dedicated* service. SoftInstigate handles infrastructure, scaling, monitoring, and updates. As a cloud customer you administer your own instance through the admin panel — see the link:/docs/sophia/administrator-guide[Administrator Guide].
