...
For more on agents, see the link:/docs/sophia/administrator-guide#_agent_management[Administrator Guide].
...
Issue a long-lived API token from the admin panel — see link:/docs/sophia/administrator-guide#_api_token_management[API Token Management] — and pass it as an `Authorization: Bearer` header. Tokens are revocable.
