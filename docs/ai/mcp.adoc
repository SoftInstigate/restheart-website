...
Two keys of a resource's `mcp` block override the reading of the permissions. Both decide **disclosure**, never access — see the note above: an agent that knows the URI can call a resource neither key announces.
