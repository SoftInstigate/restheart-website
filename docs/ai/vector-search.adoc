...
|`documentChunkingInterceptor` |Split GridFS uploads into chunks, as each bucket's `chunking` rules say; code-aware for recognized source files. `chunk-size`, `chunk-overlap`.
