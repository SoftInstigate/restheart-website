...
This is the semantic-search half of `restheart-ai` — see the xref:/docs/ai/overview.adoc[module overview] for how it fits together with xref:/docs/ai/mcp.adoc[MCP].
