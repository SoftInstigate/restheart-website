...
RESTHeart is built for developers by developers and evolved by implementing dozens of real world projects following one golden rule: _if it is complex, it is wrong_.
...
TIP: Check the link:/docs/try[demo Web Chat application]. It requires *0* lines of backend code.
