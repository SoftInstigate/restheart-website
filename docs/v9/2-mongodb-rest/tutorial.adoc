...
[.alert.alert-info]
****
**Learning Path:** This is step 4 in the link:/docs/v9/#path-1-mongodb-api-user[MongoDB API User] learning path.

**Prerequisites:**
- link:/docs/v9/1-foundations/quick-start[Quick Start] - Have RESTHeart running
- link:/docs/v9/1-foundations/security-fundamentals[Security Fundamentals] - Understand authentication
...
[.alert.alert-success]
****
**✓ You've completed the REST API Tutorial!**

You now know how to:
- Create databases and collections
- Insert, query, update, and delete documents
- Use filters and query parameters

**Continue learning:**
- **Next in learning path:** link:/docs/v9/2-mongodb-rest/read-docs[Reading Data] - Pagination, sorting, projection
- link:/docs/v9/2-mongodb-rest/write-docs[Writing Data] - Bulk operations and update operators
- link:/docs/v9/2-mongodb-rest/aggregations[Aggregations] - MongoDB aggregation pipelines via REST
****
