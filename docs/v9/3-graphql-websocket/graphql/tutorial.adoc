...
* link:/docs/v9/3-graphql-websocket/graphql/getting-started[Getting Started] - Deep dive into GraphQL apps
* link:/docs/v9/3-graphql-websocket/graphql/schema[Schema Design] - Advanced schema patterns
* link:/docs/v9/3-graphql-websocket/graphql/mappings[Mappings] - MongoDB mapping strategies
