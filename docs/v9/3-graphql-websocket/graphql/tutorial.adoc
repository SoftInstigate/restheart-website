...
[.alert.alert-info]
****
**Learning Path:** This is step 3 in the link:/docs/v9/#path-4-graphql-developer[GraphQL Developer] learning path.

**Prerequisites:**
- link:/docs/v9/1-foundations/quick-start[Quick Start] - Have RESTHeart running

**Next:** link:/docs/v9/3-graphql-websocket/graphql/getting-started[Getting Started] →
****
...
[.alert.alert-success]
****
**✓ You've completed the GraphQL Tutorial!**

You now know how to:
- Define GraphQL schemas
- Map types to MongoDB collections
- Create field resolvers
- Query your GraphQL API

**Continue learning:**
- **Next in learning path:** link:/docs/v9/3-graphql-websocket/graphql/getting-started[Getting Started] - Deep dive into GraphQL apps
