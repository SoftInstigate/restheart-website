...
1. link:/docs/v9/1-foundations/introduction[What is RESTHeart?] (10 min)
2. link:/docs/v9/1-foundations/quick-start[Quick Start] (15 min)
3. link:/docs/v9/1-foundations/security-fundamentals[Security Fundamentals] (20 min)
4. link:/docs/v9/2-mongodb-rest/tutorial[REST API Tutorial] (30 min)
5. link:/docs/v9/2-mongodb-rest/read-docs[Reading Data] (30 min)
6. link:/docs/v9/2-mongodb-rest/write-docs[Writing Data] (30 min)
7. link:/docs/v9/2-mongodb-rest/aggregations[Aggregations] (20 min)
8. link:/docs/v9/4-security/tutorial[Security Tutorial] (30 min)
9. link:/docs/v9/4-security/user-management[User Management] (20 min)
10. link:/docs/v9/4-security/permissions[Permissions] (30 min)
11. link:/docs/v9/5-deployment/configuration[Configuration] (20 min)

**✓ You're now ready to deploy a production MongoDB API!**

*Next steps:*
- Explore link:/docs/v9/2-mongodb-rest/transactions[Transactions]
- Learn link:/docs/v9/2-mongodb-rest/files[File Storage with GridFS]
- Add link:/docs/v9/2-mongodb-rest/json-schema-validation[Schema Validation]
...
1. link:/docs/v9/1-foundations/introduction[What is RESTHeart?] (10 min)
2. link:/docs/v9/1-foundations/quick-start[Quick Start] (15 min)
3. link:/docs/v9/1-foundations/core-concepts[Core Concepts] (30 min)
4. link:/docs/v9/6-framework/overview[Framework Overview] (20 min)
5. link:/docs/v9/6-framework/tutorial[Plugin Tutorial] (45 min)
6. link:/docs/v9/6-framework/services[Developing Services] (30 min)
7. link:/docs/v9/6-framework/interceptors[Developing Interceptors] (20 min)
8. link:/docs/v9/6-framework/providers[Providers & Dependency Injection] (15 min)
9. link:/docs/v9/6-framework/deploy[Deploying Plugins] (20 min)

**✓ You can now build and deploy custom plugins!**

*Next steps:*
- Try link:/docs/v9/6-framework/core-plugins-js[JavaScript Plugins]
- Learn link:/docs/v9/6-framework/initializers[Initializers]
- Explore link:/docs/v9/7-security-plugins/overview[Security Plugin Development]
...
1. link:/docs/v9/1-foundations/introduction[What is RESTHeart?] (10 min)
2. link:/docs/v9/1-foundations/setup[Installation] (20 min)
3. link:/docs/v9/1-foundations/setup-with-docker[Docker Setup] (20 min)
4. link:/docs/v9/5-deployment/configuration[Configuration] (30 min)
5. link:/docs/v9/4-security/security-hardening[Security Hardening] (20 min)
6. link:/docs/v9/4-security/tls[TLS Configuration] (15 min)
7. link:/docs/v9/5-deployment/logging[Logging] (10 min)
8. link:/docs/v9/5-deployment/monitoring[Monitoring] (15 min)
9. link:/docs/v9/5-deployment/clustering[Clustering & Load Balancing] (20 min)

**✓ You're ready to run RESTHeart in production!**

*Next steps:*
- Optimize with link:/docs/v9/5-deployment/graalvm[GraalVM Native Image]
- Set up link:/docs/v9/5-deployment/auditing[Auditing]
- Configure link:/docs/v9/5-deployment/proxy[Reverse Proxy]
...
1. link:/docs/v9/1-foundations/introduction[What is RESTHeart?] (10 min)
2. link:/docs/v9/1-foundations/quick-start[Quick Start] (15 min)
3. link:/docs/v9/3-graphql-websocket/graphql/tutorial[GraphQL Tutorial] (30 min)
4. link:/docs/v9/3-graphql-websocket/graphql/getting-started[Getting Started] (20 min)
5. link:/docs/v9/3-graphql-websocket/graphql/graphql-apps[GraphQL Apps] (20 min)
6. link:/docs/v9/3-graphql-websocket/graphql/schema[Schema Design] (20 min)
7. link:/docs/v9/3-graphql-websocket/graphql/mappings[Mappings] (20 min)
8. link:/docs/v9/3-graphql-websocket/graphql/resolvers[Resolvers] (20 min)

**✓ You can now build GraphQL APIs with RESTHeart!**

*Next steps:*
- Learn link:/docs/v9/3-graphql-websocket/graphql/n-plus-one[Performance Optimization]
- Study link:/docs/v9/3-graphql-websocket/graphql/complex-app-example[Advanced Example]
- Review link:/docs/v9/3-graphql-websocket/graphql/best-practices[Best Practices]
...
* link:/docs/v9/1-foundations/quick-start[⚡ Quick Start] - Get running in 5 minutes
* link:/docs/v9/9-reference/faq[❓ FAQ] - Common questions
* link:/docs/v9/9-reference/example-webapps[💡 Examples] - Sample applications
* link:/docs/v9/2-mongodb-rest/tutorial[📚 REST Tutorial] - Hands-on REST API guide
* link:/docs/v9/3-graphql-websocket/graphql/tutorial[📚 GraphQL Tutorial] - Hands-on GraphQL guide
...
* link:/docs/v9/9-reference/enterprise-license[Enterprise Support]
```
...
<nav class="docs-sidebar">
  <a href="/docs/v9/" class="home-link">
    <h2>RESTHeart v9</h2>
  </a>
  ...
  <div class="learning-paths">
    ...
    <ul>
      <li><a href="/docs/v9/#path-1-mongodb-api-user">MongoDB API User</a></li>
      <li><a href="/docs/v9/#path-2-plugin-developer">Plugin Developer</a></li>
      <li><a href="/docs/v9/#path-3-devops">DevOps / SRE</a></li>
      <li><a href="/docs/v9/#path-4-graphql-developer">GraphQL Developer</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part1" class="collapse">
      <li><a href="/docs/v9/1-foundations/introduction">Introduction</a></li>
      <li><a href="/docs/v9/1-foundations/quick-start">Quick Start</a></li>
      <li><a href="/docs/v9/1-foundations/setup">Setup</a></li>
      <li><a href="/docs/v9/1-foundations/setup-with-docker">Docker Setup</a></li>
      <li><a href="/docs/v9/1-foundations/core-concepts">Core Concepts</a></li>
      <li><a href="/docs/v9/1-foundations/security-fundamentals">Security Fundamentals</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part2" class="collapse">
      <li><a href="/docs/v9/2-mongodb-rest/">Overview</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/tutorial"><strong>Tutorial</strong></a></li>
      <li><a href="/docs/v9/2-mongodb-rest/read-docs">Reading Data</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/write-docs">Writing Data</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/aggregations">Aggregations</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/transactions">Transactions</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/files">File Storage</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/indexes">Indexes</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/json-schema-validation">Schema Validation</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/relationships">Relationships</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/etag">ETags</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/caching">Caching</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/read-write-concerns">Read/Write Concerns</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/dbs-collections">Databases & Collections</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/resource-uri">Resource URIs</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/representation-format">Response Format</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/csv">CSV Import</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/shard-keys">Shard Keys</a></li>
      <li><a href="/docs/v9/2-mongodb-rest/sample-data">Sample Data</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part3" class="collapse">
      ...
      <li><a href="/docs/v9/3-graphql-websocket/graphql/">Overview</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/tutorial"><strong>Tutorial</strong></a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/getting-started">Getting Started</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/graphql-apps">GraphQL Apps</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/schema">Schema Design</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/mappings">Mappings</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/resolvers">Resolvers</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/complex-app-example">Advanced Example</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/n-plus-one">Performance</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/graphql/best-practices">Best Practices</a></li>
      
      <li class="subsection">WebSocket API</li>
      <li><a href="/docs/v9/3-graphql-websocket/websocket/">Overview</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/websocket/tutorial"><strong>Tutorial</strong></a></li>
      <li><a href="/docs/v9/3-graphql-websocket/websocket/change-streams">Change Streams</a></li>
      <li><a href="/docs/v9/3-graphql-websocket/websocket/variables">Variables</a></li>
      
      <li><a href="/docs/v9/3-graphql-websocket/choosing-api">Choosing an API</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part4" class="collapse">
      <li><a href="/docs/v9/4-security/overview">Overview</a></li>
      <li><a href="/docs/v9/4-security/tutorial"><strong>Tutorial</strong></a></li>
      <li><a href="/docs/v9/4-security/authentication">Authentication</a></li>
      <li><a href="/docs/v9/4-security/authorization">Authorization</a></li>
      <li><a href="/docs/v9/4-security/user-management">User Management</a></li>
      <li><a href="/docs/v9/4-security/permissions">Permissions</a></li>
      <li><a href="/docs/v9/4-security/how-clients-authenticate">Client Authentication</a></li>
      <li><a href="/docs/v9/4-security/tls">TLS Configuration</a></li>
      <li><a href="/docs/v9/4-security/security-hardening">Security Hardening</a></li>
      <li><a href="/docs/v9/4-security/secure-connection-to-mongodb">Secure MongoDB Connection</a></li>
      <li><a href="/docs/v9/4-security/other-security-plugins">Other Security Plugins</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part5" class="collapse">
      <li><a href="/docs/v9/5-deployment/configuration">Configuration</a></li>
      <li><a href="/docs/v9/5-deployment/default-configuration">Default Configuration</a></li>
      <li><a href="/docs/v9/5-deployment/graalvm">GraalVM Native</a></li>
      <li><a href="/docs/v9/5-deployment/logging">Logging</a></li>
      <li><a href="/docs/v9/5-deployment/monitoring">Monitoring</a></li>
      <li><a href="/docs/v9/5-deployment/auditing">Auditing</a></li>
      <li><a href="/docs/v9/5-deployment/clustering">Clustering</a></li>
      <li><a href="/docs/v9/5-deployment/proxy">Proxying Requests</a></li>
      <li><a href="/docs/v9/5-deployment/static-resources">Static Resources</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part6" class="collapse">
      <li><a href="/docs/v9/6-framework/overview">Overview</a></li>
      <li><a href="/docs/v9/6-framework/tutorial"><strong>Tutorial</strong></a></li>
      <li><a href="/docs/v9/6-framework/services">Services</a></li>
      <li><a href="/docs/v9/6-framework/interceptors">Interceptors</a></li>
      <li><a href="/docs/v9/6-framework/providers">Providers</a></li>
      <li><a href="/docs/v9/6-framework/initializers">Initializers</a></li>
      <li><a href="/docs/v9/6-framework/core-plugins">Core Plugins</a></li>
      <li><a href="/docs/v9/6-framework/core-plugins-js">JavaScript Plugins</a></li>
      <li><a href="/docs/v9/6-framework/deploy">Deploying Plugins</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part7" class="collapse">
      <li><a href="/docs/v9/7-security-plugins/overview">Overview</a></li>
      <li><a href="/docs/v9/7-security-plugins/authentication-mechanisms">Auth Mechanisms</a></li>
      <li><a href="/docs/v9/7-security-plugins/authenticators">Authenticators</a></li>
      <li><a href="/docs/v9/7-security-plugins/authorizers">Authorizers</a></li>
      <li><a href="/docs/v9/7-security-plugins/token-managers">Token Managers</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part8" class="collapse">
      <li><a href="/docs/v9/8-cloud/">Overview</a></li>
      <li><a href="/docs/v9/8-cloud/getting-started">Getting Started</a></li>
      <li><a href="/docs/v9/8-cloud/root-user-setup">Root User Setup</a></li>
      <li><a href="/docs/v9/8-cloud/users-and-permissions">Users & Permissions</a></li>
      <li><a href="/docs/v9/8-cloud/full-stack-example">Full-Stack Example</a></li>
      <li><a href="/docs/v9/8-cloud/examples">Examples</a></li>
      
      <li class="subsection">Sophia AI</li>
      <li><a href="/docs/v9/8-cloud/sophia/">Overview</a></li>
      <li><a href="/docs/v9/8-cloud/sophia/setup">Setup</a></li>
      <li><a href="/docs/v9/8-cloud/sophia/user-guide">User Guide</a></li>
      <li><a href="/docs/v9/8-cloud/sophia/administrator-guide">Admin Guide</a></li>
      <li><a href="/docs/v9/8-cloud/sophia/api-documentation">API Docs</a></li>
      
      <li class="subsection">Webhooks</li>
      <li><a href="/docs/v9/8-cloud/webhook/">Overview</a></li>
      <li><a href="/docs/v9/8-cloud/webhook/getting-started">Getting Started</a></li>
      <li><a href="/docs/v9/8-cloud/webhook/user-guide">User Guide</a></li>
      <li><a href="/docs/v9/8-cloud/webhook/tutorials">Tutorials</a></li>
    </ul>
  </div>
  ...
  <div class="part">
    ...
    <ul id="part9" class="collapse">
      <li><a href="/docs/v9/9-reference/faq">FAQ</a></li>
      <li><a href="/docs/v9/9-reference/performances">Performance</a></li>
      <li><a href="/docs/v9/9-reference/upgrade-to-v8">Upgrade to v8</a></li>
      <li><a href="/docs/v9/9-reference/example-webapps">Example Apps</a></li>
      <li><a href="/docs/v9/9-reference/blog-posts">Blog Posts</a></li>
      <li><a href="/docs/v9/9-reference/enterprise-license">Enterprise License</a></li>
    </ul>
  </div>
</nav>
```
...
← Previous: link:/docs/v9/1-foundations/security-fundamentals[Security Fundamentals] | 
Next: link:/docs/v9/2-mongodb-rest/read-docs[Reading Data] →
...
* link:/docs/v9/1-foundations/introduction[What is RESTHeart]
* link:/docs/v9/1-foundations/quick-start[Quick Start] - Have RESTHeart running
...
* **Next in learning path:** link:/docs/v9/2-mongodb-rest/write-docs[Writing Data]
* **Explore related topics:**
  - link:/docs/v9/2-mongodb-rest/aggregations[Aggregations]
  - link:/docs/v9/2-mongodb-rest/json-schema-validation[Schema Validation]
  - link:/docs/v9/2-mongodb-rest/relationships[Document Relationships]
```
