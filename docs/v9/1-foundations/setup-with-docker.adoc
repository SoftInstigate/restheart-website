...
TIP: If Docker isn’t your thing, check out the link:/docs/v9/1-foundations/setup[setup] section for alternative installation methods.
...
Standalone mode runs RESTHeart without MongoDB. Learn more about link:/docs/v9/1-foundations/setup#what-is-standalone-mode[when to use standalone mode].
...
2. Check link:/docs/v9/1-foundations/quick-start#your-first-request[Your First Request] to make an API call

==== Learn Core Concepts

Before diving into features, understand how RESTHeart works:
- link:/docs/v9/1-foundations/core-concepts[Core Concepts] - Architecture and plugin system
- link:/docs/v9/1-foundations/security-fundamentals[Security Fundamentals] - Authentication and authorization

==== Start Building

Choose your learning path:
- **MongoDB User:** link:/docs/v9/2-mongodb-rest/tutorial[REST API Tutorial] or link:/docs/v9/3-graphql-websocket/graphql/tutorial[GraphQL Tutorial]
- **Plugin Developer:** link:/docs/v9/6-framework/tutorial[Plugin Development Tutorial]
- **DevOps:** link:/docs/v9/5-deployment/configuration[Configuration Guide]

==== Load Sample Data

link:/docs/v9/2-mongodb-rest/sample-data[Sample Data] provides ready-to-use MongoDB collections for experimenting with the API.
