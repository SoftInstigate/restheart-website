...
This returns all documents where `age` equals 30. The filter uses MongoDB's JSON query format. For more complex queries, see the link:/docs/v9/2-mongodb-rest/read-docs[Reading Data Guide].
