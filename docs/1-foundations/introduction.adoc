...
TIP: Check the link:/docs/2-mongodb-rest/demo-webapp.html[demo Web Chat application, window=_blank]. It requires *zero* lines of backend code.
...
link:/docs/9-reference/enterprise-license[Learn more about Enterprise License]
...
* link:/docs/1-foundations/setup[Installation Guide] - Detailed setup instructions
* link:/docs/1-foundations/core-concepts[Core Concepts] - Understanding RESTHeart's architecture
