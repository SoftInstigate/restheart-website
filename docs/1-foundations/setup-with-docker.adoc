...
TIP: If Docker isn’t your thing, check out the link:/docs/1-foundations/setup[setup] section for alternative installation methods.
...
Standalone mode runs RESTHeart without MongoDB. Learn more about link:/docs/1-foundations/setup#what-is-standalone-mode[when to use standalone mode].
