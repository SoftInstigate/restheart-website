...
For MongoDB integration, see the link:/docs/1-foundations/setup[full setup guide].
...
This returns all documents where `age` equals 30. The filter uses MongoDB's JSON query format. For more complex queries, see the link:/docs/2-mongodb-rest/read-docs[Reading Data Guide].
...
Learn more: link:/docs/1-foundations/security-fundamentals[Security Fundamentals]
...
* link:/docs/1-foundations/core-concepts[Core Concepts] - Understanding RESTHeart
* link:/docs/1-foundations/security-fundamentals[Security Fundamentals] - How security works
* link:/docs/1-foundations/setup[Setup Guide] - Detailed installation

=== Jump to Specific Topics

* link:/docs/2-mongodb-rest/tutorial[REST API Tutorial] - Hands-on REST API guide
* link:/docs/3-graphql-websocket/graphql/tutorial[GraphQL Tutorial] - Build GraphQL APIs
* link:/docs/6-framework/tutorial[Plugin Tutorial] - Develop custom services

== Need Help?

* **FAQ:** link:/docs/9-reference/faq[Common Questions]
* **Examples:** link:/docs/9-reference/example-webapps[Sample Applications]
* **Community:** link:https://github.com/SoftInstigate/restheart/issues[GitHub Issues]
* **Enterprise Support:** link:/docs/9-reference/enterprise-license[Enterprise License]
