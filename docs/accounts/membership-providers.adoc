...
it assigns the system ACL role from `accountsConfig.default-role`, clears the `inviteToken` field, and returns the user's pre-assigned membership for JWT issuance.
