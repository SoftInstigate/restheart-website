...
The invite management endpoints are *not* public. Add the following rules to your ACL (file-based or MongoDB-based) to restrict them to `owner` and `admin` roles:
