...
. **If the user exists in a different tenant** → create a new `membership` document for the caller's tenant; send a shorter "you've been added" email (no password setup needed).
