...
Refer to the [Performances](/docs/v3/performances) section for more information
and real case results.

Let's first clarify the issue addressed by the engine.

RESTHeart allows to [query documents](/docs/v3/query-documents) via GET requests
