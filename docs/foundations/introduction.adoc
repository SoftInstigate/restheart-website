...
TIP: See it for yourself with a link:/#starter-apps-content[starter app]: sign-up, login, teams and data, with *zero* lines of backend code — clone it, point it at a free service, run it.
