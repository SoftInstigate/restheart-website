...
redirect_from:
  - /docs/setup
  - /docs/get-up-and-running.html
---

TIP: **Skip the setup entirely:** https://cloud.restheart.com/docs/getting-started?utm_source=restheart.org&utm_medium=docs&utm_content=setup-page[RESTHeart Cloud] gives you a running service in a minute, with MongoDB included and nothing to install. Free to start. The rest of this page is for running it yourself.

TIP: The easiest way to run RESTHeart and MongoDB is with __Docker__. See link:/docs/setup-with-docker[Setup with Docker]

[TIP]
====
🚀 *Don't want to install anything?* Run RESTHeart and MongoDB as a fully managed service — no server to provision, no maintenance. link:https://cloud.restheart.com/signup?utm_source=restheart.org&utm_medium=docs&utm_content=setup[Try RESTHeart Cloud for free →]
====
