...
[TIP]
====
🚀 *Don't want to install anything?* Run RESTHeart and MongoDB as a fully managed service — no server to provision, no maintenance. link:https://cloud.restheart.com/signup[Try RESTHeart Cloud for free →]
====
