...
redirect_from:
  - /docs/setup-with-docker
---

TIP: **Skip the setup entirely:** https://cloud.restheart.com/docs/getting-started?utm_source=restheart.org&utm_medium=docs&utm_content=setup-docker-page[RESTHeart Cloud] gives you a running service in a minute, with MongoDB included and nothing to install. Free to start. The rest of this page is for running it yourself with Docker.
...
[TIP]
====
🚀 *Prefer not to manage containers?* Get a ready-to-use RESTHeart backend in seconds with the managed service — MongoDB included, nothing to install. link:https://cloud.restheart.com/signup?utm_source=restheart.org&utm_medium=docs&utm_content=setup-with-docker[Try RESTHeart Cloud for free →]
====
