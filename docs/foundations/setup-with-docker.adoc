...
[TIP]
====
🚀 *Prefer not to manage containers?* Get a ready-to-use RESTHeart backend in seconds with the managed service — MongoDB included, nothing to install. link:https://cloud.restheart.com/signup[Try RESTHeart Cloud for free →]
====
