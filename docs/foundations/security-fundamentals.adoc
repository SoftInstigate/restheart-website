...
**Prerequisites:** 
- link:/docs/foundations/introduction[Introduction to RESTHeart]
- link:/docs/foundations/core-concepts[Core Concepts]
...
**Learn more:** link:/docs/security/authentication/overview[Authentication Methods]
...
**Learn more:** link:/docs/security/authorization[Complete Predicate Reference]
...
**Learn more:** link:/docs/security/permissions[Permission Management]
...
2. **Use HTTPS in production** - link:/docs/security/tls[TLS Configuration]
3. **Apply least privilege** - Give users minimum required permissions
4. **Use strong passwords** - Enforce password policies
5. **Enable security hardening** - link:/docs/security/security-hardening[Security Hardening Guide]
6. **Monitor authentication failures** - link:/docs/deployment/auditing[Enable Auditing]
7. **Secure MongoDB connection** - link:/docs/security/secure-connection-to-mongodb[MongoDB TLS]
...
* link:/docs/mongodb-rest/tutorial[REST API Tutorial] - Use the API with authentication
* link:/docs/security/tutorial[Security Tutorial] - Hands-on security configuration
* link:/docs/security/user-management[User Management] - Create and manage users
* link:/docs/security/permissions[Permissions] - Configure fine-grained access control

=== Security In Depth

* link:/docs/security/authentication/overview[Authentication Methods] - All authentication options
* link:/docs/security/authorization[Advanced Authorization] - Complex permission rules
* link:/docs/security/security-hardening[Security Hardening] - Production security
* link:/docs/framework/overview[Security Plugins] - Extend security layer
