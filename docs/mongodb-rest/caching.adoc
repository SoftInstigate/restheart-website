...
[source,bash]
----
curl -i -X GET "[INSTANCE-URL]/coll?count&page=3&pagesize=10" \
...
[source,bash]
----
curl -i -X POST "[INSTANCE-URL]/_sessions/11c3ceb6-7b97-4f34-ba3f-689ea22ce6e0/_txns" \
  -H "Authorization: Basic [BASIC-AUTH]"
----
...
[source,bash]
----
curl -i -X GET "[INSTANCE-URL]/coll?sid=11c3ceb6-7b97-4f34-ba3f-689ea22ce6e0&txn=1&cache&page=3&pagesize=10" \
  -H "Authorization: Basic [BASIC-AUTH]"
----
...
[source,bash]
----
curl -i -X GET "[INSTANCE-URL]/coll?sid=11c3ceb6-7b97-4f34-ba3f-689ea22ce6e0&txn=1&cache&page=4&pagesize=10" \
  -H "Authorization: Basic [BASIC-AUTH]"
----
...
[source,bash]
----
curl -i -X DELETE "[INSTANCE-URL]/_sessions/11c3ceb6-7b97-4f34-ba3f-689ea22ce6e0/_txns/1" \
  -H "Authorization: Basic [BASIC-AUTH]"
----
