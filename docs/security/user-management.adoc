...
This section provides instructions on how to create, update and delete users with the default authenticator link:/docs/security/authentication/authenticators#_mongo_realm_authenticator[mongoRealAuthenticator].
...
TIP: **mongoRealAuthenticator** can be configured to use different properties for the username, roles an password. Check  link:/docs/security/authentication/authenticators#_mongo_realm_authenticator[mongoRealAuthenticator] for more information.
