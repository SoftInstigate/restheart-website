...
An example permission document follows (for more examples check link:https://github.com/SoftInstigate/restheart/blob/master/core/etc/acl.json[acl.json]):
...
An example follows (for more examples check link:https://github.com/SoftInstigate/restheart/blob/master/core/etc/acl.yml[acl.yml]):
...
TIP: Watch [Authorization via file and MongoDB](https://www.youtube.com/watch?v=QVk0aboHayM&t=1553s)
