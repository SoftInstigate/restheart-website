...
RESTHeart Cloud uses this for the link:/docs/cloud/api-keys[API Keys] permission, whose `apiKeys` block names the roles a key may be given. Available from RESTHeart 9.9: earlier releases loaded permissions with a projection and dropped every field they did not read.
...
link:/docs/cloud/guards[Guards] condition.
