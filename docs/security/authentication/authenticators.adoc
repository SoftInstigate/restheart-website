...
req.attachParam("override-users-db", "team_acme_db");
----
...
API keys are scoped the same way with `override-keys-db`, from v9.9 — see link:/docs/security/authentication/api-key#one-database-per-tenant[API Key Authentication].
