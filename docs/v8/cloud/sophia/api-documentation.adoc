...
[source,bash]
----
curl -X POST "https://api.bysophia.ai/chats?wm=upsert" \
...
[source,bash]
----
curl "https://api.bysophia.ai/chats/chat-123" \
  -H "Authorization: Bearer <jwt-token>"
----
...
[source,bash]
----
curl -X POST "https://api.bysophia.ai/docs.files?wm=upsert" \
  -H "Authorization: Bearer <jwt-token>" \
  -F "file=@document.pdf" \
...
[source,bash]
----
curl -X DELETE "https://api.bysophia.ai/docs.files/6507f1f462f8b7c123456789" \
  -H "Authorization: Bearer <jwt-token>"
----
...
[source,bash]
----
curl "https://api.bysophia.ai/textSegments/_aggrs/search?prompt=MongoDB%20queries" \
  -H "Authorization: Bearer <jwt-token>"
----
...
[source,bash]
----
curl "https://api.bysophia.ai/textSegments/_aggrs/search?prompt=MongoDB%20queries&avars={\"tags\":[\"public\"]}" \
  -H "Authorization: Bearer <jwt-token>"
----
...
[source,bash]
----
curl "https://api.bysophia.ai/promptTemplates?keys={\"_id\":1}" \
  -H "Authorization: Bearer <jwt-token>"
----
...
[source,bash]
----
curl "https://api.bysophia.ai/promptTemplates/default" \
  -H "Authorization: Bearer <jwt-token>"
----
...
curl -X PUT "https://api.bysophia.ai/promptTemplates/custom" \
  -H "Authorization: Bearer <jwt-token>" \
...
[source,bash]
----
curl -X PATCH "https://api.bysophia.ai/promptTemplates/custom" \
  -H "Authorization: Bearer <jwt-token>" \
  -H "Content-Type: application/json" \
  -d '{
    "options": {
...
[source,bash]
----
curl -X DELETE "https://api.bysophia.ai/promptTemplates/custom" \
  -H "Authorization: Bearer <jwt-token>"
----
