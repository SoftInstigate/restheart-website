...
NOTE: This guide follows the **Free / Shared** tier flow, where MongoDB is included and managed by RESTHeart Cloud. If you are provisioning a **Dedicated** service, you must have a MongoDB instance ready (e.g. a MongoDB Atlas cluster) *before* creating the service — see link:custom-mongodb[Connecting Your MongoDB to RESTHeart Cloud Dedicated] for prerequisites and setup instructions.
...
. *Get your Temporary Admin JWT* from your service's **Connect** page in the console — see link:/docs/cloud/tokens#service-admin-tokens[Tokens]
...
* *Upgrade to Dedicated*: See link:/docs/cloud/custom-mongodb[Connecting Your MongoDB to RESTHeart Cloud Dedicated] for instructions on bringing your own MongoDB
...
- Join our community on link:https://discord.gg/tdpWwC6ng2[Discord]
- Read the link:/docs[documentation]
