...
WARNING: Gmail caps you at **500 emails a day**, and that cap is Google's — it applies no matter what is sending. On a Shared service you get 200 from us, so Gmail is not the way to send more. It is the way to send **from your own address**.

For the full picture, see https://mailmeteor.com/blog/gmail-smtp-settings[this guide to Gmail's SMTP settings].
