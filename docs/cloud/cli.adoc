...
[IMPORTANT]
====
**RESTHeart 9.8 is the next release, and is not out yet.** `@restheart-cloud/cli` is published
with it, so `npm install -g @restheart-cloud/cli` will not resolve until then.
====
