...
Sophia also exposes a *Model Context Protocol (MCP) server*, allowing AI clients and agents such as Claude Desktop, Cursor, and VS Code to connect directly to your Sophia knowledge base.
