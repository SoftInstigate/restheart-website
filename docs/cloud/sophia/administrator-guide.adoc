...
- `password` — hashed automatically (bcrypt) on write. Strength is enforced server-side by `mongoRealmAuthenticator.enforce-minimum-password-strength` (score ≥ 3 on zxcvbn).
