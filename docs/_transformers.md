...
In [Authentication](/docs/security/authentication/) section, the *DbIdentityManager* is described.
...
classpath. See (Packaging Plugins)[/docs/develop/packaging/] for more information.
